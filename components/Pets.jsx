    ...
    <section className=' bg-pets bg-center py-6 overflow-hidden'>
      <div className=' flex flex-col lg:flex-row'>
        ...
        <div className='  hidden xl:flex xl:w-[30%] xl:pl-[160px]'>
          <Image src={Badge} width={230} height={227} alt='' className='w-auto h-auto'/>
        </div>
        ...
        <div className=' flex-1 flex flex-col lg:flex-row'>
          ...
          <div className=' lg:w-[30%] flex flex-col justify-center items-end pb-6 lg:py-2 mx-auto lg:mx-0'>
            <div className=' text-center text-white '>
              ...
              {/* image */}
              <div className=' h-[150px] w-[150px] mx-auto lg:mx-0 border-4 border-white rounded-full'>
            ...
            <div  className=' flex flex-wrap gap-4 justify-center lg:justify-end lg:-mr-6'>
              {pets.map((pet,index)=>(
                <div 
                  ...
                  {/* overlay */}
                  <div className={` w-full h-full absolute rounded-full ${petIndex === index ? 'border-2 border-white': ' bg-black/40'}`}/>
